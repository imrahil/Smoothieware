...
#define ohw_logo_antipixel_width 128
...
static const uint8_t ohw_logo_antipixel_bits[] = {
    ...
    ,
...
void Panel::on_idle(void *argument)
{
    if (this->start_up) {
        ...
        this->lcd->clear();
        this->lcd->setCursor(0, 0); this->lcd->printf("Witamy w Smoothie");
        this->lcd->setCursor(0, 1); this->lcd->printf("(pozdr dla olo2000pm)");
        //this->lcd->setCursor(0, 2); this->lcd->printf("%s", date.substr(0, 20).c_str());
        this->lcd->setCursor(0, 3); this->lcd->printf("Prosze czekac....");

        if (this->lcd->hasGraphics()) {
            this->lcd->bltGlyph(0, 34, ohw_logo_antipixel_width, ohw_logo_antipixel_height, ohw_logo_antipixel_bits);
        }
